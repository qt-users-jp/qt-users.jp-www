...
QtObject {
    ...
    property EventService connpass: Connpass {
        id: connpass
        db: root.db
        service_type: root.service_type_map['connpass'] ? root.service_type_map['connpass'] : -1
    }
    ...
    function createDatabase() {
        db.transaction(
            function(tx) {
                ...
                var services = ['connpass', 'doorkeeper', 'zusaar', 'atnd']
